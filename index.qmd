...
#| echo: false
#| output: false
Modelo_ACOLITE.stepwise(max_vars = 3, log_y = True, log_X = True)
```
...
#| echo: false
#| output: false
Modelo_ACOLITE.stepwise(max_vars = 1, log_y = True, log_X = True, cocientes = True)
```
...
Modelo_ACOLITE.stepwise(max_vars = 1, log_y = True, cocientes = True)
